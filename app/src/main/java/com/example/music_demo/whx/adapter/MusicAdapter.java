...
import com.example.music_demo.whx.R;
...
public class MusicAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder.titleTv = view.findViewById(R.id.music_item_title_tv);
            viewHolder.artistTv = view.findViewById(R.id.music_item_artist_tv);
            viewHolder.albumImg = view.findViewById(R.id.music_item_album_img);
            viewHolder.isPlayingView = view.findViewById(R.id.music_item_playing_v);
        ...
        viewHolder.albumImg.setImageBitmap(Common.musicList.get(position).albumBip);
